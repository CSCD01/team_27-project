...
internal class RequestDesktopCheckItemViewHolder/* package */(
    ...
    private val desktop_switch: Switch = itemView.findViewById(R.id.check_menu_item_checkbox)

    init {
        desktop_switch.isChecked = fragment.session.shouldRequestDesktopSite
        desktop_switch.setOnCheckedChangeListener(this)
    }
